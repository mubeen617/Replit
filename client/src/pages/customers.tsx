...
export default function Customers() {
  ...
  const handleDelete = (customer: Customer) => {
    if (confirm(`Are you sure you want to delete ${customer.name}? This will also delete all associated users.`)) {
        ...
        return (
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="text-sm text-secondary-500">{customer.domain}</div>
            </div>
          </div>
        );
      },
          ...
          <div className="bg-white rounded-xl shadow-sm">
            ...
            <div className="px-6 py-4 border-b border-secondary-200">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold text-secondary-900">Customer Organizations</h3>
